This repository demonstrates an end-to-end Proof of Value (PoV) for Identity Verification (IDV) in an FSI KYC workflow using AI Vision-Language Models.
...
Image → VLM → Structured Extraction → Validation →
